...
{
    [kOS.Safe.Utilities.KOSNomenclature("IR3ControlGroup")]
    public class IRControlGroupWrapper : Structure
    {
        private readonly IR3Wrapper.IControlGroup cg;
        private readonly SharedObjects shared;

        public IRControlGroupWrapper(IR3Wrapper.IControlGroup init, SharedObjects shared)
        {
            cg = init;
            this.shared = shared;
            InitializeSuffixes();
        ...
        {
            var list = new List <IR3ServoWrapper> ();
