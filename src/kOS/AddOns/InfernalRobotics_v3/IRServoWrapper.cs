...
{
    [kOS.Safe.Utilities.KOSNomenclature("IR3Servo")]
    public class IR3ServoWrapper : Structure
    {
        private readonly IR3Wrapper.IServo servo;
        private readonly SharedObjects shared;
        private readonly PartValue partValue;

        public IR3ServoWrapper(IR3Wrapper.IServo init, SharedObjects shared)
        {
            servo = init;
            this.shared = shared;
